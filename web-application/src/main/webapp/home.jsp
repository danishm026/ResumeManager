...
<link type="text/css" rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/general.css" />
</head>
<body>
	...
	<div>
		...
		<form action="register" method="post">
			...
			<p>Password: <input type="password" name="passwordHash" id="registrationPassword" /></p>
